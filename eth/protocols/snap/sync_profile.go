...
func (s *syncer) reportProfile() {
	...
	log.Info("Sync loop profile: account internals", "codeskips", s.codeSkips, "codeseen", len(s.codeSeen), "submitwait", s.prof.submitWait.String(), "forward", s.prof.forward.String())
