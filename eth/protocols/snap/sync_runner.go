...
// snap/1 and snap/2 syncers: the runner only knows about opaque jobs, the
// profile to account the submission waits against and the runloop wakeup
// channel to poke once it drains.
