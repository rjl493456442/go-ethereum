...
func TestTxIndexer(t *testing.T) {
	...
	for _, c := range cases {
		...
		rawdb.WriteAncientBlocks(db, types.EncodeBlocks(append([]*types.Block{gspec.ToBlock()}, blocks...), types.EncodeBlockReceiptLists(append([]types.Receipts{{}}, receipts...))))
...
func TestTxIndexerRepair(t *testing.T) {
	...
	for _, c := range cases {
		...
		rawdb.WriteAncientBlocks(db, types.EncodeBlocks(append([]*types.Block{gspec.ToBlock()}, blocks...), encReceipts))
