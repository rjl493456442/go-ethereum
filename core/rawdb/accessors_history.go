...
// DeleteStateHistories completely removes all history indexing data, including
// indexes for accounts and storages.
func DeleteStateHistories(db ethdb.KeyValueRangeDeleter) {
...
// DeleteTrienodeHistories completely removes all trienode history indexing data.
func DeleteTrienodeHistories(db ethdb.KeyValueRangeDeleter) {
