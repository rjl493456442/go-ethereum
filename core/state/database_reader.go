...
type ContractCodeReader interface {
	// Code retrieves a particular contract's code. Return nil code if the
	// requested contract code doesn't exist
	Code(addr common.Address, codeHash common.Hash) []byte

	// CodeSize retrieves a particular contracts code's size. Return zero code
...
// reader is the wrapper of ContractCodeReader and StateReader interface, providing
// access to Ethereum State.
type reader struct {
	ContractCodeReader
	StateReader
}
