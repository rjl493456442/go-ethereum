...
// PayloadHeaderProof is the pre-Gloas proof format. It commits to the complete
// execution payload header at the execution_payload body field.
type PayloadHeaderProof struct {
	PayloadHeader *ExecutionHeader
	Branch        merkle.Values
}

func (p *PayloadHeaderProof) BlockHash() common.Hash {
	return p.PayloadHeader.BlockHash()
}

func (p *PayloadHeaderProof) Validate(bodyRoot common.Hash) error {
